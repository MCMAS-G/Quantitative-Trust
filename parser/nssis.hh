...
#line 181 "parser/nssis.hh" // lalr1.cc:377
    };
#else
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 8433,     ///< Last index in yytable_.
      yynnts_ = 128,  ///< Number of nonterminal symbols.
...
#line 610 "parser/nssis.hh" // lalr1.cc:377
