...
%union {
  ...
  pair<pair<string*, string*>*, pair<modal_formula*, modal_formula*>*>* ID_ID_modal_formula_modal_formula;
  pair<pair<string*, pair<string*, string*>*>*, pair<modal_formula*, modal_formula*>*>* ID_ID_ID_modal_formula_modal_formula;
  pair<pair<pair<string*, string*>*, pair<modal_formula*, modal_formula*>*>*, pair<int, int>* >* ID_ID_modal_formula_modal_formula_equation;
...
%token FORMULAE IMPLIES AG EG AX EX AF EF A E UNTIL K GK GCK O D
%token MULTIASSIGNMENT SINGLEASSIGNMENT SEMANTICS
%token BITAND BITOR BITNOT BITXOR /* bit operators */
%token X F G 
%token SC FU SCC WCC FUW FUS CAS RES DES ASS TR TP TC//VI 
...
%type <ID_ID_modal_formula> scprefix
%type <ID_ID_modal_formula_modal_formula> sccprefix
%type <ID_ID_ID_modal_formula_modal_formula> sccprefix2
%type <ID_ID_modal_formula_modal_formula_equation> gtprefix
...
| ID COLON integer TO integer {
  if($1!=NULL) {
    if($3>$5)
      cout << "warning: the lower bound " << $3 << " is greater than the upper bound " << $5 << endl;
    int i = search_string_table($1);
    if(i>=0) {
...
| evalist ID IF evaboolcond SEMICOLON {
  if($2!=NULL && $4!=NULL) {
    if(is_evaluation->find(*$2) != is_evaluation->end())
...
| groupdeflist ID gplprefix namelist gplsufffix {
  if($2!=NULL && $3==1 && $4!=NULL && $5==1) {
    if(is_groups->find(*$2) != is_groups->end())
...
scprefix: LB ID COMMA ID COMMA formula RB {
  if($2!=NULL && $4!=NULL && $6!=NULL) {
    pair<string *, string *> *two;// = new pair<string *, string *>($2, $4);
    int i = search_string_table($2);
    int j = search_string_table($4);
    if(i>=0) {
      if(j>=0) {
	two = new pair<string *, string *>((*string_table)[i], (*string_table)[j]);
	free($4);
      } else {
	two = new pair<string *, string *>((*string_table)[i], $4);
	string_table->push_back($4);
      }
      free($2);
    } else {
      if(j>=0) {
	two = new pair<string *, string *>($2, (*string_table)[j]);
	free($4);
      } else {
	two = new pair<string *, string *>($2, $4);
	string_table->push_back($4);
      }
      string_table->push_back($2);
    }
    $$ = new pair<pair<string *, string *>*, modal_formula *>(two, $6);
  } else
    $$ = NULL;
 }
| LB ID COMMA ENVIRONMENT COMMA formula RB {
  if($2!=NULL && $6!=NULL) {
    ...
    if(i>=0) {
      ...
      two = new pair<string *, string *>($2, (*string_table)[0]);
      string_table->push_back($2);
    }
    $$ = new pair<pair<string *, string *>*, modal_formula *>(two, $6);
  } else
...
| LB ENVIRONMENT COMMA ID COMMA formula RB {
  if($4!=NULL && $6!=NULL) {
    pair<string *, string *> *two;// = new pair<string *, string *>($2, (*string_table)[0]);
    int i = search_string_table($4);
    if(i>=0) {
      two = new pair<string *, string *>((*string_table)[0], (*string_table)[i]);
      free($4);
    } else {
      two = new pair<string *, string *>((*string_table)[0], $4);
      string_table->push_back($4);
    }
    $$ = new pair<pair<string *, string *>*, modal_formula *>(two, $6);
  } else
...
sccprefix2: LB ID COMMA ID COMMA ID COMMA formula COMMA formula RB {
  if($2!=NULL && $4!=NULL && $6!=NULL && $8!=NULL & $10!=NULL) {
    pair<string *, string *> *two;
    pair<string *, pair<string *, string *>* > *three;// = new pair<string *, string *>($2, $4);
    int i = search_string_table($2);
    int j = search_string_table($4);
    int k = search_string_table($6);
    if(i>=0) {
      if(j>=0) {
	if(k>=0) {
	  ...
	  two = new pair<string *, string *>((*string_table)[j], $6);
	  string_table->push_back($6);
	}
	three = new pair<string *, pair<string *, string *>* >((*string_table)[i], two);
	free($4);
      } else {
	if(k>=0) {
	  two = new pair<string *, string *>($4, (*string_table)[k]);
	  free($6);
	} else {
	  two = new pair<string *, string *>($4, $6);
	  string_table->push_back($6);
	}
	three = new pair<string *, pair<string *, string *>* >((*string_table)[i], two);
	string_table->push_back($4);
	...
	three = new pair<string *, pair<string *, string *>* >($2, two);
	free($4);
      } else {
	if(k>=0) {
	  two = new pair<string *, string *>($4, (*string_table)[k]);
    ...
    pair<modal_formula *, modal_formula *> *twoformulae = new pair<modal_formula *, modal_formula *>($8, $10);
    $$ = new pair<pair<string *, pair<string *, string *>*>*, pair<modal_formula *, modal_formula *> *>(three, twoformulae);
  } else
    $$ = NULL;
 }
sccprefix: LB ID COMMA ID COMMA formula COMMA formula RB {
  if($2!=NULL && $4!=NULL && $6!=NULL && $8!=NULL) {
    pair<string *, string *> *two;// = new pair<string *, string *>($2, $4);
    int i = search_string_table($2);
    int j = search_string_table($4);
    if(i>=0) {
    ...
    pair<modal_formula *, modal_formula *> *twoformulae = new pair<modal_formula *, modal_formula *>($6, $8);
    $$ = new pair<pair<string *, string *>*, pair<modal_formula *, modal_formula *> *>(two, twoformulae);
  } else
    $$ = NULL;
 }
| LB ID COMMA ENVIRONMENT COMMA formula COMMA formula RB {
  if($2!=NULL && $6!=NULL && $8!=NULL) {
    pair<string *, string *> *two;// = new pair<string *, string *>($2, (*string_table)[0]);
    int i = search_string_table($2);
    if(i>=0) {
      two = new pair<string *, string *>((*string_table)[i], (*string_table)[0]);
...
| LB ENVIRONMENT COMMA ID COMMA formula COMMA formula RB {
...
gtprefix: LB ID COMMA ID COMMA formula COMMA formula COMMA logicop NUMBER RB {
  if($2!=NULL && $4!=NULL && $6!=NULL && $8!=NULL) {
    pair<string *, string *> *two;// = new pair<string *, string *>($2, $4);
    int i = search_string_table($2);
    int j = search_string_table($4);
    ...
    pair<modal_formula *, modal_formula *> *twoformulae = new pair<modal_formula *, modal_formula *>($6, $8);
    pair<int, int> *twointegers = new pair<int, int>($10, $11);
    ...
    $$ = new pair<pair<pair<string*, string*>*, pair<modal_formula*, modal_formula*>*>*, pair<int, int>* >(ids_formulae, twointegers);
  } else
    $$ = NULL;
 }
| error {
...
| SC scprefix {
	if($2!=NULL) {
    atomic_proposition *ap = new atomic_proposition($2->first->first);
    atomic_proposition *ap1 = new atomic_proposition($2->first->second);
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(51, a, b, $2->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| FU scprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(52, a, b, $2->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
/*| VI scprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(53, a, b, $2->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| WCC sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(61, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| SCC sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(62, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| FUW sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(63, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| FUS sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(64, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| CAS sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(65, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| RES sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(66, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| TR sccprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(71, a, b, $2->second->first, $2->second->second);
    free($2->first);
    free($2);
  } else
    $$ = NULL;
...
| DES sccprefix2 {
	if($2!=NULL) {
    atomic_proposition *ap = new atomic_proposition($2->first->first);
    atomic_proposition *ap1 = new atomic_proposition($2->first->second->first);
    atomic_proposition *ap2 = new atomic_proposition($2->first->second->second);
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    modal_formula *c = new modal_formula(ap2);
    $$ = new modal_formula(67, a, b, c, $2->second->first, $2->second->second);
    free($2->first->second);
    free($2->first);
    free($2);
  } else
...
| TP gtprefix {
	if($2!=NULL) {
    atomic_proposition *ap = new atomic_proposition($2->first->first->first);
    atomic_proposition *ap1 = new atomic_proposition($2->first->first->second);
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(81, a, b, $2->first->second->first, $2->first->second->second, $2->second->first, $2->second->second);
    free($2->first->first);
    free($2->second);
    free($2);
  } else
...
| TC gtprefix {
    ...
    modal_formula *a = new modal_formula(ap);
    modal_formula *b = new modal_formula(ap1);
    $$ = new modal_formula(82, a, b, $2->first->second->first, $2->first->second->second, $2->second->first, $2->second->second);
    free($2->first->first);
    free($2->second);
    free($2);
  } else
