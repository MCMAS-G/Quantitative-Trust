...
public:
  ...
  virtual void print_state(string prefix, BDD state, BDDvector v);
  virtual void print_stateXML(ofstream * myfile, BDD state, BDDvector v);
  virtual string state_to_str(BDD state, BDDvector v);
  virtual bool is_valid_state(BDD state, BDDvector v);
  virtual ADD build_ADD_tree(Cudd * bddmgr, ADDvector * addv, map< string,
			     ADD > *ADD_cache);
  virtual BDD build_all_BDDs(Cudd * bddmgr, BDDvector * v);
};
...
public:
  ...
  void print_state(string prefix, BDD state, BDDvector v);
  void print_stateXML(ofstream * myfile, BDD state, BDDvector v);
  string state_to_str(BDD state, BDDvector v);
  bool is_valid_state(BDD state, BDDvector v);
  ADD build_ADD_tree(Cudd * bddmgr, ADDvector * addv, map< string,
		     ADD > *ADD_cache);
	BDD build_individual_BDD(Cudd * bddmgr, BDDvector *v, vector< bool > *vindex, int index_begin);
  BDD build_all_BDDs(Cudd * bddmgr, BDDvector * v);
};
...
public:
  ...
  ADD build_ADD_tree(Cudd * bddmgr, ADDvector * addv, map< string,
		     ADD > *ADD_cache);
  BDD build_all_BDDs(Cudd * bddmgr, BDDvector * v);
	BDD build_individual_BDD(Cudd * bddmgr, BDDvector *v, vector< int > *vindex, int index_begin);
  void build_all_individual_BDDs(Cudd * bddmgr, BDDvector *v, vector< BDD* > *bddblocks, unsigned int count);
};
...
public:
  ...
  virtual ADD build_ADD_tree(Cudd * bddmgr, ADDvector * addv, map< string,
			     ADD > *ADD_cache);
  virtual BDD encode_BDD_true(Cudd * bddmgr, BDDvector * v);
  virtual BDD encode_BDD_false(Cudd * bddmgr, BDDvector * v);
...
public:
  ...
  BDD encode_BDD_true(Cudd * bddmgr, BDDvector * v);
  BDD encode_BDD_false(Cudd * bddmgr, BDDvector * v);
};
...
public:
  ...
  modal_formula(unsigned char o, modal_formula * f1, modal_formula * f2, modal_formula * f3, modal_formula * f4);	// four operands formula
  modal_formula(unsigned char o, modal_formula * f1, modal_formula * f2, modal_formula * f3, modal_formula * f4, modal_formula * f5);	// five operands formula
  modal_formula(unsigned char o, modal_formula * f1, modal_formula * f2, modal_formula * f3, modal_formula * f4, int equality, int bound);
  ...
  bool build_cex_fair(BDD * state, unsigned int index, BDD fair_reach,
		      bdd_parameters * para);
};
...
public:
  ...
  void print_stateXML(ofstream * myfile, BDD state, BDDvector v);
  string state_to_str(BDD state, BDDvector v);
  string action_to_str(BDD state, BDDvector v);

  /*
   * delete all local states of other agent
   */
  BDD project_local_state(BDD * state, Cudd * bddmgr, BDDvector * v);
	BDDvector* get_local_state_vector(Cudd * bddmgr, BDDvector * v);

  //BDDvector get_BDDvector(Cudd * bddmgr, BDDvector * v, BDDvector * pv);
  BDD project_local_trans(BDD * trans, Cudd * bddmgr, BDDvector * v,
			  BDDvector * pv);
  /* 
  ...
  bool check_lobsvars(map< string, basictype * >*envars);
	...
	BDD get_SC(bdd_parameters * para);
};
...
public:
  ...
  void print(BDDvector * v, BDDvector * a);
  void printXML(ofstream * myfile, BDDvector * v);
  void to_str(ofstream * myfile, BDDvector * a);
  string index_to_string(BDDvector * a);
